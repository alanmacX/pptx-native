    ...
    return {
        ...
        "surface": {
            ...
            "carriers": {
                ...
                "media": {
                    ...
                    "effects": ["shadow", "glow", "blur", "reflection"],
                    "timing": all_timing + ["mediaCommand"],
                    "gaps": ["trim", "posterFrameExtraction", "captions"],
                    "note": "Use local/data media assets. Visual choreography works on the media poster picture; play/pause/stop compile to p:cmd media commands.",
                },
                "table": {
                    "status": COMPILES,
                    "ooxmlTarget": "p:graphicFrame / a:tbl",
            ...
            "propertyMatrix": {
                ...
                "mediaCommand": {"compilesOn": ["media"], "gapsOn": ["textbox", "shape", "freeform", "connector", "picture", "table", "chart", "group"]},
        ...
        "animation": {
            "within": {
                ...
                "mediaCommand": {
                    "status": COMPILES,
                    "intent": "Play, pause, or stop embedded video/audio using native p:cmd timing.",
                    "effects": ["mediaPlay", "mediaPause", "mediaStop"],
                    "dsl": "data-ppt-anim=\"media:play; trigger:onClick\"",
                    "params": ["target", "trigger", "delay", "startSeconds"],
                    "carrier": "media",
                },
                "textBuild": {
                    "effect": "build",
