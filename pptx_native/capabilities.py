        ...
        "surface": {
            ...
            "carriers": {
                ...
                "picture": {
                    ...
                    "sceneType": "image",
                    "properties": ["geometry", "dataImage", "rotation", "flip"],
                    "effects": ["shadow", "glow", "blur", "reflection"],
                    "timing": all_timing,
            ...
            "propertyMatrix": {
                "solidFill": {"compilesOn": ["shape", "freeform", "tableCell"], "gapsOn": ["picture", "connector", "chart"]},
                "gradientFill": {"compilesOn": ["shape", "freeform"], "gapsOn": ["tableCell", "picture", "connector", "chart"]},
                "stroke": {"compilesOn": ["shape", "freeform", "connector"], "gapsOn": ["picture", "chart"]},
                "textRuns": {"compilesOn": ["textbox", "shapeText", "tableCell"], "gapsOn": ["chartLabels"]},
                "shadow": {"compilesOn": ["shape", "freeform", "picture"], "gapsOn": ["textbox", "connector", "table", "chart"]},
                "glow": {"compilesOn": ["shape", "freeform", "picture"], "gapsOn": ["textbox", "connector", "table", "chart"]},
                "blur": {"compilesOn": ["shape", "freeform", "picture"], "gapsOn": ["textbox", "connector", "table", "chart"], "notAnimatable": True},
                "reflection": {"compilesOn": ["shape", "freeform", "picture"], "gapsOn": ["textbox", "connector", "table", "chart"]},
                "crop": {"compilesOn": [], "gapsOn": ["picture"]},
                "animation": {"compilesOn": ["textbox", "shape", "freeform", "connector", "picture", "table", "chart"], "gapsOn": ["group"]},
